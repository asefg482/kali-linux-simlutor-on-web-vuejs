...
<script>
    ...
    export default {
        ...
        data() {
            return {
                wallpapers: {
                    'wall-1': "./images/wallpapers/minified/wall-1.png",
                    'wall-2': "./images/wallpapers/minified/wall-2.jpg",
                    'wall-3': "./images/wallpapers/minified/wall-3.jpg",
                    'wall-4': "./images/wallpapers/minified/wall-4.jpg",
                    'wall-5': "./images/wallpapers/minified/wall-5.png",
                    'wall-6': "./images/wallpapers/minified/wall-6.png",
                    'wall-7': "./images/wallpapers/minified/wall-7.jpg",
