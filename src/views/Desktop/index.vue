<template>
  <div class="w-screen h-screen overflow-hidden relative select-none">
    ...
    <div v-for="window in this.windowList" :key="window.id">
      ...
      <PhotoShop v-if="window.id === 'photoshop'" :meta="window"/>
      <FlutterLab v-if="window.id === 'flutterlab'" :meta="window"/>
      <codesandboxeditor v-if="window.id === 'codesandboxeditor'" :meta="window"/>
      <Auto_CAD v-if="window.id === 'autocad'" :meta="window"/>
      <ToDoList v-if="window.id === 'todo-ist'" :meta="window"/>
      <Settings v-if="window.id === 'settings'" :meta="window"/>
      <AboutObj9527 v-if="window.id === 'about'" :meta="window"/>
...
import FlutterLab from "../../components/apps/FlutterLab";
import Auto_CAD from "../../components/apps/Auto_CAD";
...
import AboutObj9527 from "../../components/apps/About";
...
import codesandboxeditor from "../../components/apps/CodeSandBoxEditor";
